...
CLASS_NAMES = [
    ...
    'American_Three_toed_Woodpecker', 'Anna_Hummingbird', 'Artic_Tern', 'Asian-Green-Bee-Eater', 'Baird_Sparrow', 
    'Baltimore_Oriole', 'Bank_Swallow', 'Barn_Swallow', 'Bay_breasted_Warbler', 'Belted_Kingfisher', 
    'Bewick_Wren', 'Black_Tern', 'Black_and_white_Warbler', 'Black_billed_Cuckoo', 'Black_capped_Vireo', 
    'Black_footed_Albatross', 'Black_throated_Blue_Warbler', 'Black_throated_Sparrow', 'Blue_Grosbeak', 'Blue_Jay', 
    'Blue_headed_Vireo', 'Blue_winged_Warbler', 'Boat_tailed_Grackle', 'Bobolink', 'Bohemian_Waxwing', 
    'Brandt_Cormorant', 'Brewer_Blackbird', 'Brewer_Sparrow', 'Bronzed_Cowbird', 'Brown-Headed-Barbet', 
    'Brown_Creeper', 'Brown_Pelican', 'Brown_Thrasher', 'Cactus_Wren', 'California_Gull', 
    'Canada_Warbler', 'Cape_Glossy_Starling', 'Cape_May_Warbler', 'Cardinal', 'Carolina_Wren', 
    'Caspian_Tern', 'Cattle-Egret', 'Cedar_Waxwing', 'Cerulean_Warbler', 'Chestnut_sided_Warbler', 
    'Chipping_Sparrow', 'Chuck_will_Widow', 'Clark_Nutcracker', 'Clay_colored_Sparrow', 'Cliff_Swallow', 
    'Common-Kingfisher', 'Common-Myna', 'Common-Rosefinch', 'Common-Tailorbird', 'Common_Raven', 
    'Common_Tern', 'Common_Yellowthroat', 'Coppersmith-Barbet', 'Crested_Auklet', 'Dark_eyed_Junco', 
    'Downy_Woodpecker', 'Eared_Grebe', 'Eastern_Towhee', 'Elegant_Tern', 'European_Goldfinch', 
    'Evening_Grosbeak', 'Field_Sparrow', 'Fish_Crow', 'Florida_Jay', 'Forest-Wagtail', 
    'Forsters_Tern', 'Fox_Sparrow', 'Frigatebird', 'Gadwall', 'Geococcyx', 
    'Glaucous_winged_Gull', 'Golden_winged_Warbler', 'Grasshopper_Sparrow', 'Gray-Wagtail', 'Gray_Catbird', 
    ...
    'Hooded_Warbler', 'Hoopoe', 'Horned_Grebe', 'Horned_Lark', 'Horned_Puffin', 
    'House-Crow', 'House_Sparrow', 'House_Wren', 'Indian-Grey-Hornbill', 'Indian-Peacock', 
    'Indian-Pitta', 'Indian-Roller', 'Indigo_Bunting', 'Ivory_Gull', 'Jungle-Babbler', 
    ...
    'Louisiana_Waterthrush', 'Magnolia_Warbler', 'Mallard', 'Mangrove_Cuckoo', 'Marsh_Wren', 
    'Mockingbird', 'Mourning_Warbler', 'Myrtle_Warbler', 'Nashville_Warbler', 'Nelson_Sharp_tailed_Sparrow', 
    'Nighthawk', 'Northern-Lapwing', 'Northern_Flicker', 'Northern_Fulmar', 'Northern_Waterthrush', 
    'Olive_sided_Flycatcher', 'Orange_crowned_Warbler', 'Orchard_Oriole', 'Ovenbird', 'Pacific_Loon', 
    'Painted_Bunting', 'Palm_Warbler', 'Parakeet_Auklet', 'Pelagic_Cormorant', 'Philadelphia_Vireo', 
    'Pied_Kingfisher', 'Pied_billed_Grebe', 'Pigeon_Guillemot', 'Pileated_Woodpecker', 'Pine_Grosbeak', 
    'Pine_Warbler', 'Pomarine_Jaeger', 'Prairie_Warbler', 'Prothonotary_Warbler', 'Purple_Finch', 
    'Red-Wattled-Lapwing', 'Red_bellied_Woodpecker', 'Red_breasted_Merganser', 'Red_cockaded_Woodpecker', 'Red_eyed_Vireo', 
    'Red_faced_Cormorant', 'Red_headed_Woodpecker', 'Red_legged_Kittiwake', 'Red_winged_Blackbird', 'Rhinoceros_Auklet', 
    'Ring_billed_Gull', 'Ringed_Kingfisher', 'Rock_Wren', 'Rose_breasted_Grosbeak', 'Ruby_throated_Hummingbird', 
    'Ruddy-Shelduck', 'Rufous-Treepie', 'Rufous_Hummingbird', 'Rusty_Blackbird', 'Sage_Thrasher', 
    'Sarus-Crane', 'Savannah_Sparrow', 'Sayornis', 'Scarlet_Tanager', 'Scissor_tailed_Flycatcher', 
    'Scott_Oriole', 'Seaside_Sparrow', 'Shiny_Cowbird', 'Slaty_backed_Gull', 'Song_Sparrow', 
    'Sooty_Albatross', 'Spotted_Catbird', 'Summer_Tanager', 'Swainson_Warbler', 'Tennessee_Warbler', 
    'Tree_Sparrow', 'Tree_Swallow', 'Tropical_Kingbird', 'Vermilion_Flycatcher', 'Vesper_Sparrow', 
    'Warbling_Vireo', 'Western_Grebe', 'Western_Gull', 'Western_Meadowlark', 'Western_Wood_Pewee', 
    'Whip_poor_Will', 'White-Breasted-Kingfisher', 'White-Breasted-Waterhen', 'White-Wagtail', 'White_Pelican', 
...
def load_model():
    ...
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(len(CLASS_NAMES), activation='softmax') # CRITICAL FIX: Dynamically scales to 225
    ])
...
if uploaded_file is not None:
    ...
    with col2:
        with st.spinner("Analyzing plumage patterns..."):
            ...
            true_conf = float(np.max(predictions[0])) * 100
            ...
            <div class="result-container">
                ...
                <p style="color: #34495e; font-size: 18px;"><b>Confidence Score: {true_conf:.2f}%</b></p>
            </div>
            """, unsafe_allow_html=True)
            
            st.write("") 
            st.progress(true_conf / 100)
